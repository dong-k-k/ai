...
- context 비교: `fx-chronos/outputs/metrics/core/usd_krw_zero_shot_validation_context_comparison.csv`
- 선택 후보 Validation: `fx-chronos/outputs/metrics/finetuning/chronos2_lora_h20_ctx756_lr1e-5_steps300_seed42_validation_summary.csv`
- 최종 Test 요약: `fx-chronos/outputs/metrics/finetuning/chronos2_lora_h20_ctx756_lr1e-5_steps300_seed42_final_test_2022_2025_summary.csv`
- 최종 Test 기준일별 결과: `fx-chronos/outputs/metrics/finetuning/chronos2_lora_h20_ctx756_lr1e-5_steps300_seed42_final_test_2022_2025_by_origin.csv`
- 최종 Test lead-step별 결과: `fx-chronos/outputs/metrics/finetuning/chronos2_lora_h20_ctx756_lr1e-5_steps300_seed42_final_test_2022_2025_by_lead.csv`
